...
import { listAsientos } from "@/features/finanzas/queries";
    ...
    <div className="mx-auto max-w-5xl space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Asientos de partida doble generados automáticamente por cada venta,
          compra, producción, cobro y pago.
        </p>
      </div>
                  ...
                  asientos.map((a) => (
                    <TableRow key={a.id}>
                      ...
                      <TableCell className="text-right">
                        <Button variant="ghost" size="sm" render={<Link href={`/finanzas/asientos/${a.id}`} />}>
                          Ver
                        </Button>
                      </TableCell>
                    </TableRow>
