...
import {
  ...
  editarCuenta,
  toggleCuentaActivo,
} from "@/features/finanzas/actions";
import type { CuentaConSaldo } from "@/features/finanzas/queries";
import { TIPO_CUENTA, TIPO_CUENTA_LABEL } from "@/features/finanzas/schema";
