...
import { registrarCobro } from "@/features/cc/actions";
    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          {saldo > 0 ? (
            <Badge variant="destructive">Nos debe</Badge>
          ) : saldo < 0 ? (
            <Badge variant="secondary">A favor del cliente</Badge>
          ) : (
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          ...
          <div className="grid gap-3 py-2">
            ...
            <div className="grid gap-1.5">
              ...
              <Select
                ...
                value={medioPago}
                onValueChange={(v) =>
                  setMedioPago((v as (typeof MEDIOS_PAGO_CC)[number]) ?? "efectivo")
                }
              >
          ...
          <DialogFooter>
            ...
            <Button onClick={onCobrar} disabled={pending || !monto}>
